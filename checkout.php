...
<body>
    ...
    <section class="checkout-orders">
      ...
      ?>
                <p> <?= $fetch_cart['name']; ?>
                    <span>(<?= 'RM'.$fetch_cart['price'].' x '. $fetch_cart['quantity']; ?>)</span>
                </p>
                <?php
            }
         }else{
      ...
      ?>
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>city :</span>
                    <input type="text" name="city" placeholder="e.g. Penang" class="box" maxlength="50" required>
                </div>
                <div class="inputBox">
                    <span>state :</span>
                    <input type="text" name="state" placeholder="e.g. Penang" class="box" maxlength="50" required>
                </div>
                <div class="inputBox">
                    <span>country :</span>
